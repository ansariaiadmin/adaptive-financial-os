...
echo -e "${NC}"
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  🧙‍♂️ جادوگر نصب Adaptive Financial OS v3.1.0 — پشتیبانی صفر — تاریکی روشن شد${NC}"
...
cat > .env <<EOF
# adaptive-financial-os — .env — جادوگر v3.1.0 — پشتیبانی صفر — تاریکی روشن شد — $(date)
PGHOST=localhost
PGPORT=5432
PGUSER=afos
PGPASSWORD=afos
