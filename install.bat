...
echo.
echo ========================================
echo   adaptive-financial-os — Setup Wizard v3.1.0 — پشتیبانی صفر — تاریکی روشن شد — Windows
echo ========================================
echo.
echo سلام! 👋 جادوگر adaptive-financial-os — v3.1.0 — تاریکی روشن شد
echo.
...
:create_env
(
echo # adaptive-financial-os — .env — v3.1.0 — تاریکی روشن شد — %date% %time%
...
echo.
echo 🎉 جادو تمام! adaptive-financial-os آماده — تاریکی روشن شد! 🎉
