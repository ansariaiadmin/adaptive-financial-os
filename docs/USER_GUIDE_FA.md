# راهنمای کامل Adaptive Financial OS — Double-Entry Ledger — برای افراد غیر فنی

**نسخه:** v0.9.4 — نصب خودکار + آپدیت خودکار
...
- **v0.9.3 (Strict Final 10/10 True):** نسخه غیرفنی + نصب خودکار + آپدیت خودکار (همین نسخه)
...
- ایشو باز کن: https://github.com/ansariaiadmin/adaptive-financial-os/issues

**برای افراد کاملا غیر فنی:** فقط `install.sh` را اجرا کن، بعد مرورگر را باز کن به http://localhost:3000 — همین!
