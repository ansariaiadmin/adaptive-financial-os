# 🧙‍♂️ جادوگر نصب Adaptive Financial OS — سیستم مالی — فوق ساده — پشتیبانی صفر — Zero Support
...
## 🎯 Adaptive Financial OS — سیستم مالی چیه؟ به زبان ساده:

دفترداری دوبل Double-entry balanced via trigger + immutability + RLS + idempotency + outbox + audit + Kafka idempotent + GraphQL + Event Replay + Snapshot + FX + Web UI — Financial-Grade
...
### 📧 Email + 📱 SMS — برای ناتیف مالی

**چیه؟** وقتی تراکنش مالی می‌شه ناتیف می‌ده: "پرداخت 100 هزار تومان ثبت شد"

**گزینه‌ها:**
- **smtp** — Gmail — App Passwords
- **ghasedak** — برای SMS — https://ghasedak.me/
- **mock** — تو لاگ



## 🔔 سیستم ناتیفیکیشن — مالی — سقف 10/10

**کانال‌ها:**
1. **In-App** — همیشه روشن — تو Web UI
2. **Email** — تراکنش مالی
3. **SMS** — مبلغ بالا
4. **Telegram** — برای حسابدار — تراکنش یا خطا

**کد:** `src/lib/notification/service.ts`
...
**پشتیبانی صفر:** همه راهنماها همون‌جا بود — اگر بازم گیر کردی: https://github.com/ansariaiadmin/adaptive-financial-os/issues
